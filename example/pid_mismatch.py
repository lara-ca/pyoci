...
"""
"""
Testing the OCI method with PID controller structure on a SISO system (mismatch case)
Demonstrates controller design using PID structure when the ideal controller is outside
...
# mismatch case: G has a zero at z = 0.5, making the ideal controller outside the PID class
...
# defining the fixed controller structure (full denominator constraint)
...
nk = 2      # time delay (number of samples)
